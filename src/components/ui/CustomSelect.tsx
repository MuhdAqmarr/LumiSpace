...
export default function CustomSelect({
  ...
  return (
    <div className={`relative w-full ${className}`} ref={containerRef}>
      ...
      {/* Dropdown Menu */}
      <div
        className={`absolute left-0 top-full z-[9999] mt-2 w-full origin-top transform overflow-hidden rounded-xl border border-border bg-bg-surface/95 backdrop-blur-xl shadow-xl transition-all duration-300 ${
          isOpen
